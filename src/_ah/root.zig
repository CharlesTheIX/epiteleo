...
pub const AudioHandler = struct {
    ...
    pub fn loadAudio(self: *AudioHandler, io: *std.Io, audio_type: enum { Music, Sfx }, file_path: []const u8) void {
    ...
    pub fn playAudio(self: *AudioHandler, audio_type: enum { Music, Sfx }) void {
        switch (audio_type) {
            .Music => {
                if (self.music) |music| {
